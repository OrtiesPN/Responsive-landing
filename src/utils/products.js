...
const Glue = [
    ...
    },
    {
        ...
        image: recoll25k_img,
        description: "Двухкомпонентный эпоксидно-полиуретановый безводный клей с новой формулой 9 кг на 1 кг был разработан по случаю празднования 25-летия деятельности фирмы Recoll. Клей, гарантирующий хорошую сцепляемость, предназначен для наклеивания любых деревянных полов на цементную стяжку или на уже существующие неабсорбирующие половые покрытия (мрамор, плитка, мозаичные полы, деревянные основы)",
        specs: recoll25k_pdf,
    },
    {
        id: "gl06",
    ...
    },
    {
        ...
        name: "IBC 10-2C",
        image: ibc102c_img,
        description: "Двухкомпонентный клей для деревянных полов без растворителей. Двухкомпонентный эпоксидно-полиуретановый безводный клей для наклеивания деревянных полов на цементную стяжку или на уже существующие неабсорбирующие половые покрытия (мрамор, плитка, мозаичные полы, деревянные основы)",
        specs: ibc_pdf,
    },
];
